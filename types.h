...
enum LriDef
{
    ...
    E_BatChaStt                       = 0x00295A00,   // *00* Current battery charge status
    ...
    E_MeteringGridMsTotWOut           = 0x00463600,   // *40* Power grid feed-in
    E_MeteringGridMsTotWIn            = 0x00463700,   // *40* Power grid reference
    ...
    E_BatDiagCapacThrpCnt             = 0x00491E00,   // *40* Number of battery charge throughputs
    E_BatDiagTotAhIn                  = 0x00492600,   // *00* Amp hours counter for battery charge
    E_BatDiagTotAhOut                 = 0x00492700,   // *00* Amp hours counter for battery discharge
    E_BatTmpVal                       = 0x00495B00,   // *40* Battery temperature
    E_BatVol                          = 0x00495C00,   // *40* Battery voltage
    E_BatAmp                          = 0x00495D00,   // *40* Battery current
